        ...
        <div className="mt-12 space-y-8">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <a
              ...
              className="text-lg font-medium text-gray-900 hover:text-mubboo transition-colors"
            >
              admin@mubboo.ai
            </a>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-lg text-gray-700">Mubboo &middot; Sydney, Australia</p>
          </div>
          ...
          <div className="flex justify-center gap-6">
            <a
              ...
              className="flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-mubboo transition-colors"
            >
